...
class JugadorController{
    ...
    public function addJugador() {
       ...
       if (!isset($_POST['nombre']) || empty($_POST['nombre'])) {
        ...
        $id = $this->model->insertJugador($nombre, $pais, $posicion, $fecha, $altura, $puntaje, $id_equipo);
    ...
    public function editJugador($id_jugador) {
        AuthHelper::verify();
        if(isset($_POST['nombre'])&& isset($_POST['pais']) &&  isset($_POST['posicion'])  &&  isset($_POST['fecha']) &&
            isset($_POST['altura']) && isset($_POST['puntaje']) && isset($_POST['id_equipo']) &&
        !empty($_POST['nombre'])  && !empty($_POST['pais']) && !empty($_POST['posicion'])  && !empty($_POST['fecha'])
